...
|--------|------|----------|---------|------|----------|
| API_001 | 認証API /api/auth | 独自実装 + 外部連携 | JWT生成・検証は本システム、顧客情報はcustomer-hub-api経由 | [API_001_auth](../detailed_design/API_001_auth/functional_design.md) |
| API_002 | 書籍API /api/books | 外部API呼び出し | back-office-apiから書籍情報を取得 | [API_002_books](../detailed_design/API_002_books/functional_design.md) |
| API_003 | 注文API /api/orders | 独自実装 + 外部連携 | 注文処理は本システム、在庫更新はback-office-api経由 | [API_003_orders](../detailed_design/API_003_orders/functional_design.md) |
| API_004 | 画像API /api/images | 独自実装 | WAR内リソースを直接配信 | [API_004_images](../detailed_design/API_004_images/functional_design.md) |
...
* [../detailed_design/API_001_auth/functional_design.md](../detailed_design/API_001_auth/functional_design.md) - 認証API機能設計書
* [../detailed_design/API_002_books/functional_design.md](../detailed_design/API_002_books/functional_design.md) - 書籍API機能設計書
* [../detailed_design/API_003_orders/functional_design.md](../detailed_design/API_003_orders/functional_design.md) - 注文API機能設計書
* [../detailed_design/API_004_images/functional_design.md](../detailed_design/API_004_images/functional_design.md) - 画像API機能設計書
