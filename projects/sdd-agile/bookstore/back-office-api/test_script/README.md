...
```bash
API_BASE="http://localhost:8080/back-office-api-sdd-agile"
```
...
```bash
# カテゴリ一覧を確認
curl http://localhost:8080/back-office-api-sdd-agile/api/categories

# 書籍一覧を確認
curl http://localhost:8080/back-office-api-sdd-agile/api/books
