...
echo "🌐 API Base URL: http://localhost:8080/back-office-api-sdd-agile"
echo ""
echo "⚠️  事前確認:"
...
echo "      ./gradlew :back-office-api-sdd-agile:setupHsqldb"
echo "      ./gradlew :back-office-api-sdd-agile:deploy"
echo ""
