...
**例：**
* 別のポート: `API_BASE="http://localhost:9090/berry-books-api-sdd-agile"`
* ルートコンテキスト: `API_BASE="http://localhost:8080"`
* リモートサーバー: `API_BASE="https://example.com/berry-books-api-sdd-agile"`
...
curl http://localhost:8080/berry-books-api-sdd-agile/api/books
