# customer-spa-vibe プロジェクト（Vibe Coding研修用）
...
> **Note:** このプロジェクトは**Vibe Coding（バイブコーディング）**の研修用プロジェクトです。
> AIとの自然な対話を通じてコーディングを進める手法を体験できます。

> **Vibe Codingとは:**
> - AIとの対話を通じて、インタラクティブにコードを開発する手法
> - 仕様書ではなく、会話形式でAIに指示を出しながら実装を進める
> - 完成版（master/customer-spa）を参考にしながら、自由な発想で改善・拡張を行う
...
```bash
# 1. プロジェクトのディレクトリに移動
cd projects/vibe/bookstore/customer-spa-vibe
...
```
projects/vibe/bookstore/customer-spa-vibe/
├── src/
│   ├── components/
