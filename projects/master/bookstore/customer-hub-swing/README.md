...
```
projects/master/bookstore/customer-swing/
├── src/
│   └── main/
│       └── java/
│           └── dev/
...
- [berry-books-spa (React版・完成版)](../berry-books-spa/README.md)
- [customer-spa-vibe (React版・Vibe Coding研修用)](../../../vibe/online/customer-spa-vibe/README.md)
