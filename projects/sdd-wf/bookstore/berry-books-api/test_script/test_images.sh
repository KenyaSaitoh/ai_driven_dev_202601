...
if [ "$HTTP_STATUS" == "200" ]; then
    ...
    if [ "$HTTP_STATUS" == "404" ]; then
        echo "   画像ファイルが存在しません"
        echo "   配置先: projects/sdd-wf/bookstore/berry-books-api/src/main/webapp/resources/images/covers/"
...
if [ "$HTTP_STATUS" == "200" ]; then
    ...
    echo "💡 画像ファイルの配置方法:"
    echo "   1. 配置先ディレクトリ:"
    echo "      projects/sdd-wf/bookstore/berry-books-api/src/main/webapp/resources/images/covers/"
    echo ""
    echo "   2. ファイル名の規則:"
