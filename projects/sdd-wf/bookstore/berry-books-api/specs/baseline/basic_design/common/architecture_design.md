...
sequenceDiagram
    ...
    Client->>ImageResource: GE/api/images/covers/1
...
| 書籍API（外部API連携） | [API_002_books/detailed_design.md](../detailed_design/API_002_books/detailed_design.md) |
| 注文API | [API_003_orders/detailed_design.md](../detailed_design/API_003_orders/detailed_design.md) |
| 画像API | [API_004_images/detailed_design.md](../detailed_design/API_004_images/detailed_design.md) |
...
sequenceDiagram
    ...
    Client->>OrderResource: POS/api/orders
