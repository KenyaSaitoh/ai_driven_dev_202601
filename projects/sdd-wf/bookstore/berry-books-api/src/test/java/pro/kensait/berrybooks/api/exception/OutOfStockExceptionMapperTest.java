...
@DisplayName("OutOfStockExceptionMapper単体テスト")
class OutOfStockExceptionMapperTest {
    ...
    void setUp() {
        ...
        try {
            java.lang.reflect.Field field = OutOfStockExceptionMapper.class.getDeclaredField("uriInfo");
    ...
    @Test
    @DisplayName("OutOfStockExceptionを409 Conflictにマッピング")
    void testToResponse_OutOfStockException() {
        // Given: OutOfStockException
        OutOfStockException exception = new OutOfStockException("在庫が不足しています");
        ...
        assertEquals("在庫が不足しています", errorResponse.message());
