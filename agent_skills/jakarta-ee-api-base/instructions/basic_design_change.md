...
change_spec: "projects/sdd-wf/bookstore/back-office-api-sdd/specs/baseline/basic_design/CHANGES.md"
```
...
例：
* BookService にメソッド追加 → `src/main/java/.../BookService.java`
* Book エンティティにフィールド追加 → `src/main/java/.../entity/Book.java`
* API_001_Books の変更 → `src/main/java/.../api/BookResource.java`
...
- OrderService に cancelOrder() メソッド追加

#### 2. data_model.md の変更
- ORDER_TRAN テーブルに cancel_reason カラム追加
...
- src/main/java/.../api/OrderResource.java
- src/main/java/.../api/dto/OrderCancelRequest.java (新規)

#### テスト（3ファイル）
- src/test/java/.../OrderServiceTest.java
- src/test/java/.../OrderServiceIntegrationTest.java
- src/test/java/.../OrderE2ETest.java
```
...
mv specs/baseline/basic_design/CHANGES.md \
   specs/baseline/basic_design/changes_archive/20260118_order_cancel.md
```
