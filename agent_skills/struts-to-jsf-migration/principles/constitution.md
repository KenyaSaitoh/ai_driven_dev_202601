...
この憲章は、Apache Struts 1.xからJakarta Faces (JSF)へのマイグレーションを行うすべてのプロジェクトで共通的に適用される原則と手法を定義する
...
### 原則1: Code-to-Codeではなく、Code-to-Spec-to-Code
...
既存コード分析で生成する仕様書は、以下を含む完全なものとする：
